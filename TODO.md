...
- [x] **W10.5b — claw-squad smart-context (index foundation)** ✅
  ...
  - Orchestrator integration (`claw-squad run --smart-context` flag wiring) intentionally deferred to a focused follow-up — the data foundation here is what justifies that wiring landing as a small change
