...
Repo overview for Claude Code (and humans) joining work mid-stream.

## Layout

- `src/claudestruct/` — Python CLI. One-shot Claude calls with smart context gathering and prompt caching. Entry: `src/claudestruct/cli.py`.
